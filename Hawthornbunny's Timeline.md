...
This timeline is used with permission from Fimfiction user Hawthornbunny.  The most up to date version of this timeline can be found at the [Time Loop Forum Post.](http://www.fimfiction.net/group/199133/the-time-loop-trilogy/thread/87711/hard-reset-2-timeline)  Note that this will probably look better on the forums because it becomes a nightmare to keep them synchronized in markdown.

Hawthornbunny has been working on this timeline in parallel with this project and will be posting it on Fimfiction in the Time Loop forums.  It's a magnificent piece of work already so breaking it apart to merge into the guides would do it a disservice.
...
- I: Celestia respawns back several hours to the beginning of the morning, and waits out the day. During this time, she learns the circumstances under which Twilight cast the timeloop spell, and also discovers the changeling invasion.
- I: Celestia spends several more loops learning everything she can about the changeling invasion. She discovers that Chrysalis is also a timelooper, and apparently Chrysalis also learns this as well (or already knew). Despite several attempts to prevent the invasion by changing the past, she cannot defeat the invasion because Chrysalis simply changes her tactics every time she loses.
...
- I: Twilight respawns back to the moment of Chrysalis' attack on the library. She immediately says 'Darjeeling!'. It is technically C-376, T-2, but Celestia has counted it as C-376, T-35 because she is still using Twilight's numbers.
...
- S: As Twilight said in Eakin's Hard Reset, the problem of defeating the invasion came down to not having enough time. With Celestia on board at an earlier reset point, their chances are dramatically improved. The problem of not having enough time also comes up in this chapter.
- S: For non-American readers, a Roach Motel is a trap used to catch cockroaches. In this case, it of course refers to a trap that they intend to spring on Chrysalis. I'm British, I had to look it up. :)
...
- I: Twilight and Celestia hurry to a phaeton depot. (A phaeton is a pegasus-pulled chariot.)
...
- I: Twilight leaves on one of the phaetons. Celestia stays behind to handle the fighting at the palace.
...
- Q: What happened?
- S: There are many possibilities here and we'll probably never know for sure, but our personal guess is that Twilight gifted Celestia with a personal secret of her own, as a return gesture of trust, and allowed Celestia to reset to retain that information. It's not likely that Celestia has any sinister reason for withholding information from Twilight, as we've just seen how dedicated she is to maintaining trust with her fellow timeloopers.
- I: Celestia resets.
### T-48, C-17
...
- S: Chapter 5 begins. There's only one loop shown in chapter 5. It's possible Celestia had more loops between the end of chapter 4 and the beginning of chapter 5, but none are mentioned, and no loop numbers are given this chapter.
- C: Twilight respawns, utterly depressed at the death of her friends - which, since it occurs before she has time to get there (possibly even before her reset point), she has no chance of preventing. She believes her friends are dead for good.
- C: Celestia takes Twilight outside to show her a literal doomsday that she has created. With godlike power and the ability to replay time over and over again, Celestia is free to do whatever she pleases, and is using this opportunity to blow off steam after the tragic events of the last chapter. She's using her powers to delay the explosion of the Elements, which she's carrying with her in some saddlebags, to get as much fun out of it as possible.
...
- S: Twilight says that telekinesis can only a whole object, not part of it. This is actually different to the show, where we've seen unicorns do this plenty of times.
...
- I: There's an unknown number of missing loops here (probably one). This may be a loop in which Twilight decided to go through the doomsday a second time. We don't know yet.
...
- I: Twilight realises that this loop has begun differently to the last one, in which Celestia was present at the moment of her respawn. This time, Celestia isn't here, implying that a loop has occurred since her last reset.
- I: Twilight goes to see Celestia in her chambers. Celestia remembers going through one loop of the doomsday, which implies Twilight has gone through it twice (but only remembers one of those loops).
- Q: Celestia must know Twilight has been through it twice, as that's the only way Twilight could remember it. Why didn't Celestia find it odd that Twilight chose to go through it a second time?
...
- Q: At one point, while Celestia is discussing the awkward moments in the doomsday loop that she remembers, she say- S: "Well, you know how it is. I did something monstrous and you called me a monster." It didn't happen that way in the loop we saw: Twilight never actually called Celestia a monster, but rather Celestia referred to herself in that manner. Is Celestia misremembering, or did it actually happen that way in the loop Celestia remembers (but Twilight doesn't)?
...
- I: Celestia replays the conversation as she did last loop, up to the point where Twilight suggests resetting the loop count to T-0, C-0 again.
...
- S: As Twilight later notes, Genmaicha is a kind of tea, as was Darjeeling. For the record, Darjeeling is Indian tea and Genmaicha is Japanese green tea.
...
- S: For completeness, we'll list them:
...
- S: Twilight's codewords are based on legendary Equestrian historical figures, as mentioned in the show episode "Hearth's Warming Eve".
...
- S: In mathematics, delta is commonly used to represent a change in a quantity (for example, delta v = change in velocity = acceleration).
...
- S: 'Hornet's Nest' is part of the idiom 'to stir up a hornet's nest', which means 'to create trouble' or 'to provoke a dangerous situation'. Given the name of the previous operation, it's also probably a metaphor for 'the changeling army' or even 'the changeling hive'. The next arc of the story is called 'Among Monsters', which lends credence to this interpretation, and implies that Celestia and Twilight are planning to perform a little infiltration of their own. As they both have invisibility cloaks which Chrysalis is known to be unable to penetrate, they certainly have the means to do so.
